...
class MenasApi:
    ...
    def _login(self):
        if hasattr(self, 'session'):
            logger.debug('restarting Menas session')
        ...
        query_data = {'username': self.username,'password': self.password}
        response = self._session.post(self.login_url, params=query_data)
